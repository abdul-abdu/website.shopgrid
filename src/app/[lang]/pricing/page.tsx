...
export default function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      monthlyPrice: "130 000",
      yearlyPrice: "1 300 000",
      features: [
        "Up to 100 products",
        "Advanced analytics",
        "AI product tools",
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                answer:
                  "Yes! Both Starter and Pro plans come with a 14-day free trial. No credit card required to start.",
              },
              {
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary to-primary/80 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            <Trans>
              Join hundreds of businesses already using Shopgrid. Start your
              free trial today.
            </Trans>
          </p>
          <Link
