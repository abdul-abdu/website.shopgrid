        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              <Trans>
                Powerful Features for <span className="text-primary">Telegram Commerce</span>
              </Trans>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              <Trans>
                Everything you need to turn your Telegram channel into a thriving online store. Built specifically for
                the Telegram ecosystem with modern tools and AI-powered features.
              </Trans>
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  <Trans key={1}>Native Telegram Web App components and hooks</Trans>,
                  <Trans key={2}>Main button integration for checkout actions</Trans>,
                  <Trans key={3}>Settings button and back button native handling</Trans>,
                  <Trans key={4}>Automatic theme synchronization with Telegram</Trans>,
                  <Trans key={5}>Responsive navigation optimized for mobile Telegram</Trans>,
                ].map((text, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                <Trans>
                  Manage your entire business from one powerful dashboard. Track sales, manage inventory, and analyze
                  performance with real-time data and insights.
                </Trans>
              </p>
                ...
                {[
                  {
                    ...
                    desc: (
                      <Trans>
                        Process orders, update status, track pending/paid/shipped/cancelled orders with real-time
                        updates
                      </Trans>
                    ),
                  },
                  {
                    ...
                    desc: (
                      <Trans>
                        Track total revenue, average order value, and financial performance with detailed breakdowns
                      </Trans>
                    ),
                  },
                  {
                    title: <Trans>Customer Database</Trans>,
                    desc: <Trans>Manage customer information and purchase history with multilingual support</Trans>,
                  },
                  {
                    title: <Trans>Product Performance</Trans>,
                    desc: <Trans>View top-performing products, revenue tracking, and inventory insights</Trans>,
                  },
                ].map((item, index) => (
            ...
            {[
              {
                ...
                description: (
                  <Trans>
                    Upload product photos with automatic image optimization and CDN delivery for fast loading across all
                    devices.
                  </Trans>
                ),
              },
              {
                ...
                description: (
                  <Trans>
                    Create product listings with multilingual support (Uzbek, Russian, English) and rich formatting for
                    descriptions.
                  </Trans>
                ),
              },
              {
                ...
                description: (
                  <Trans>
                    Get AI-powered pricing recommendations based on market analysis, competition, and product features.
                  </Trans>
                ),
              },
            ].map((feature, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                <Trans>
                  Deep integration with Telegram's ecosystem including theme adaptation, bot integration, and native
                  Telegram Web App features for seamless user experience.
                </Trans>
              </p>
              <div className="space-y-4">
                {[
                  <Trans key={1}>Telegram Web App integration with native UI</Trans>,
                  <Trans key={2}>Automatic theme adaptation to user preferences</Trans>,
                  <Trans key={3}>Built-in Telegram invoice generation and payment</Trans>,
                  <Trans key={4}>Real-time order notifications and updates</Trans>,
                  <Trans key={5}>Multi-language support</Trans>,
                ].map((text, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: (
                  <Trans>Generate and send invoices directly through Telegram with automatic processing</Trans>
                ),
              },
              {
